...
const About = () => {
  return (
    ...
    >
      <Heading id="more">Who I am & What I do</Heading>
      <Text>
        Junior web developper belge de 28 ans. blablabla Passionnée de code,
        café, voyage, littérature et un tas d'autres petites choses.
      </Text>
      <Timeline>
        <TimeList>
          <TimeEvent>
            ...
            <TimeEventCopy>
              ...
              <Description>
                ...
                <br></br> HTML5, Bootstrap, CSS/SCSS, JS/jQuery, VueJS, Drupal,
                Wordpress
                <br></br>
                <strong>UX/UI</strong>
                <br></br> Adobe XD, Figma, Invision, Illustrator, Photoshop,
                Approfondissement UX
                <br></br>
                <strong>Backend</strong>
                <br></br> Laravel
                <br></br>
                <strong>Divers</strong>
                <br></br> Git, Jira, Agile, ...
              </Description>
            </TimeEventCopy>
          </TimeEvent>
          <TimeEvent>
            ...
            <TimeEventCopy>
              ...
              <Description>
                <strong>Frontend</strong>
                <br></br>Apprentissage appronfondi sur projets réels. Sitewebs
                responsives avec HTML5, CSS/SCSS, Frameworks tels que Bootstrap
                et Materialize, JS/jQuery, React, Wordpress...
                <br></br>
                <strong>Backend</strong>
                <br></br> Bases en PHP et SQL
                <br></br>
                <strong>Divers</strong>
                <br></br>Git/github, lighthouse, figma ...
              </Description>
            </TimeEventCopy>
          </TimeEvent>
        </TimeList>
