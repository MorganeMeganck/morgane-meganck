  ...
  componentWillMount() {
    this.setState({
      projects: [
        {
          1: {
            project_byline: "Fun translation api",
            project_credits: [
              { credit_role: "developer", credit_name: "Morgane Meganck" },
              { credit_role: "api", credit_name: "fun translation" },
            ],
            project_description:
            ...
            project_client: "Morgane Meganck",
